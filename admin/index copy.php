...
<html>
  <head>
    ...
    <title>DarkStats | Dashboard</title>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/charts/chartjs.html"><i class="fa  fa-gears"></i> ID Finder</a></li>
                    ...
                    <div class="box-body chat" id="chat-box">
                      ...
                      <div class="item">
                        ...
                        <p class="message">
                          ...
                          if you find any bugs or failures in DarkStats please contact me on discord <a href="https://discord.com/users/820828835440230400" target="_blank">Jaax#7825</a>
                        </p>
                        <!-- ATTACHMENT 
