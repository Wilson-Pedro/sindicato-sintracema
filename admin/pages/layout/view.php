        ...
        <?php
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row["nome_conjuge"] . "</td>";
                    echo "<td>" . $row["nome_filhos"] . "</td>";
                    echo "<td>" . $row["assinatura_socio"] . "</td>";
                    echo "<td>" . $row["numero_matricula"] . "</td>";
                    // Adicione mais células conforme necessário para exibir mais colunas
                    echo "</tr>";
                }
            } else {
