          ...
          <div class="accordion" id="accordionExample">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  Acreditamos na importância de promover a colaboração entre autoridades de saúde, organizações comunitárias e a população em geral. Propomos a criação de fóruns de discussão, grupos de trabalho e reuniões regulares, onde as pessoas possam compartilhar informações, trocar experiências e discutir estratégias eficazes de controle dos mosquitos transmissores.
                </div>
              </div>
            </div>
          </div>
